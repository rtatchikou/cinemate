...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="bg-white border-b-2 border-gray-200 dark:border-b-1 dark:bg-gray-900 dark:border-gray-200">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            ...
            <span className=" text-2xl self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
              Cinemate
            </span>
          </Link>
